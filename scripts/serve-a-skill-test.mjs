...
const server = createServer(async (req, res) => {
  try {
    ...
    if (!/^([ac]-skill-test\.html|js\/[\w-]+\.js|css\/[\w-]+\.css)$/.test(relative)) {
...
server.listen(port, "127.0.0.1", () => console.log(`開発確認: http://127.0.0.1:${port}/a-skill-test.html / http://127.0.0.1:${port}/c-skill-test.html (Ctrl+Cで停止)`));
